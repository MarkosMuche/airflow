...
def run():
    ...
    parsed_msgs = (p | 'ReadFromPubSub' >> beam.io.ReadFromPubSub(input_topic) #TODO: Use ReadFromPubSub to read in messages
    ...
    (parsed_msgs
        | "WindowByMinute" >> beam.WindowInto(beam.window.FixedWindows(60)) # TODO: Window into 1 minute long windows
        | "CountPerMinute" >> beam.CombineGlobally(CountCombineFn()).without_defaults() # TODO: Count number of messages per window.
        ...
        | 'WriteAggToBQ' >>  beam.io.WriteToBigQuery(
                  ...
                  create_disposition=beam.io.BigQueryDisposition.CREATE_IF_NEEDED,
                  write_disposition=beam.io.BigQueryDisposition.WRITE_APPEND
                  )# TODO: Write aggregated data to BigQuery table
    )
